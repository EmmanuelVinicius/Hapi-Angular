...
const UsuarioTesteSchema = require('./../database/strategies/postgres/schemas/usuarioTesteSchema');
...
describe('Suite de testes do Postgres Strategy', function () {
    ...
    this.beforeAll(async () => {
        ...
        const model = await Postgres.defineModel(connection, UsuarioTesteSchema)
